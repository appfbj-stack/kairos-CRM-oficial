...
import { ChevronRight, LayoutDashboard, Users, MessageSquare, MessageCircle, KanbanSquare, Settings, Sparkles, Contact, CheckSquare, Package, Briefcase, BookOpen, Zap, Shield } from 'lucide-react';
...
export function SidebarNav({ items, userRole }: { items: NavItem[]; userRole?: string }) {
  const pathname = usePathname();
  const visible = items.filter((item) => !item.superAdminOnly || userRole === 'SUPER_ADMIN');
  return (
